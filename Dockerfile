...
RUN case ${TARGETPLATFORM} in \
    ...
    wget -r -np -nd -R "index.html*" -A "eweos-$DOWNARCH-tarball.tar.xz" https://os-repo-auto.ewe.moe/eweos-images-wget/ && mv ./*.tar.xz image.tar.xz && tar xf ./image.tar.xz -C /rootfs
